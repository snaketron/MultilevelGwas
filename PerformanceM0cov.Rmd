...
# models
m0 <- rstan::stan_model(file = "src/stan_files/M0c.stan")
m0fast <- rstan::stan_model(file = "src/stan_files/M0cfast.stan")
```
...
# cor <- rnorm(n = N, mean = 0.5, sd = 0.25)
...
rm(X, N, S, Y, Y2, Yq, Yd, cor, data.list, gt.data, 
...
summary(pfast, par = "rho")$summary[, "mean"]
```
