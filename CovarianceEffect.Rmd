...
rm(X, N, S, Y, Y2, Y3, Yq, Yd, data.list, gt.data, K, 
...
## Analysis
  * Strain-level effects are not affected 
  
```{r, fig.width=5, fig.height=5}
p.summary <- summary(p, par = "beta")$summary[, "mean"]
pc.summary <- summary(pc, par = "beta")$summary[, "mean"]
plot(pc.summary, p.summary,
     xlab = "strain-level slope Cov+", 
     ylab = "strain-level slope Cov-", 
     main = "")
abline(0, 1, col = "red")
```
...
## Analysis
  * Uncertainty of SNP-level effects
